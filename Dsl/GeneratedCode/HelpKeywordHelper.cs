...
namespace UPM_IPS.DSPMPVSCD_UPMovie
{
	...
	/// </remarks>
	public partial class DSPMPVSCD_UPMovieHelpKeywordHelper : DSPMPVSCD_UPMovieHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieHelpKeywordHelper.
		/// </summary>
		protected DSPMPVSCD_UPMovieHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DSPMPVSCD_UPMovieHelpKeywordHelper.
		/// </summary>
		public static DSPMPVSCD_UPMovieHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DSPMPVSCD_UPMovieHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieHelpKeywordHelperBase.
		/// </summary>
		protected DSPMPVSCD_UPMovieHelpKeywordHelperBase()
			: base() { }
