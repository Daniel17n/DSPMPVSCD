...
namespace UPM_IPS.DSPMPVSCDProyectoIPS
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)
				{
					if (candidateTarget is global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement sourceExampleElement = (global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)candidateSource;
						global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement targetExampleElement = (global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)
				{
					if (target is global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement sourceAccepted = (global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)source;
						global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement targetAccepted = (global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElement)target;
						DslModeling::ElementLink result = new global::UPM_IPS.DSPMPVSCDProyectoIPS.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
