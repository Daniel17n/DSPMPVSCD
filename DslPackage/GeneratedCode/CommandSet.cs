...
namespace UPM_IPS.DSPMPVSCDProyectoIPS
{
	...
	/// </summary>
	internal partial class DSPMPVSCDProyectoIPSCommandSet : DSPMPVSCDProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSCommandSet.
		/// </summary>
		public DSPMPVSCDProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DSPMPVSCDProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSCommandSetBase.
		/// </summary>
		protected DSPMPVSCDProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDSPMPVSCDProyectoIPSExplorerCommand,
				typeof(DSPMPVSCDProyectoIPSEditorFactory).GUID);
		...
		{
			DSPMPVSCDProyectoIPSExplorerToolWindow explorer = this.DSPMPVSCDProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DSPMPVSCDProyectoIPSDocData CurrentDSPMPVSCDProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DSPMPVSCDProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DSPMPVSCDProyectoIPSDocView CurrentDSPMPVSCDProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DSPMPVSCDProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected DSPMPVSCDProyectoIPSExplorerToolWindow DSPMPVSCDProyectoIPSExplorerToolWindow
		{
			get
			{
				DSPMPVSCDProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DSPMPVSCDProyectoIPSExplorerToolWindow), true) as DSPMPVSCDProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DSPMPVSCDProyectoIPSExplorerToolWindow explorerWindow = this.DSPMPVSCDProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DSPMPVSCDProyectoIPSClipboardCommandSet : DSPMPVSCDProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSClipboardCommandSet.
		/// </summary>
		public DSPMPVSCDProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DSPMPVSCDProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected DSPMPVSCDProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
