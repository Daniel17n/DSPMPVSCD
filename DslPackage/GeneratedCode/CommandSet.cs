...
namespace UPM_IPS.DSPMPVSCD_UPMovie
{
	...
	/// </summary>
	internal partial class DSPMPVSCD_UPMovieCommandSet : DSPMPVSCD_UPMovieCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieCommandSet.
		/// </summary>
		public DSPMPVSCD_UPMovieCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DSPMPVSCD_UPMovieCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieCommandSetBase.
		/// </summary>
		protected DSPMPVSCD_UPMovieCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDSPMPVSCD_UPMovieExplorerCommand,
				typeof(DSPMPVSCD_UPMovieEditorFactory).GUID);
		...
		{
			DSPMPVSCD_UPMovieExplorerToolWindow explorer = this.DSPMPVSCD_UPMovieExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DSPMPVSCD_UPMovieDocData CurrentDSPMPVSCD_UPMovieDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DSPMPVSCD_UPMovieDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DSPMPVSCD_UPMovieDocView CurrentDSPMPVSCD_UPMovieDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DSPMPVSCD_UPMovieDocView;
			}
		}
		...
		/// </summary>
		protected DSPMPVSCD_UPMovieExplorerToolWindow DSPMPVSCD_UPMovieExplorerToolWindow
		{
			get
			{
				DSPMPVSCD_UPMovieExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DSPMPVSCD_UPMovieExplorerToolWindow), true) as DSPMPVSCD_UPMovieExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DSPMPVSCD_UPMovieExplorerToolWindow explorerWindow = this.DSPMPVSCD_UPMovieExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DSPMPVSCD_UPMovieClipboardCommandSet : DSPMPVSCD_UPMovieClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieClipboardCommandSet.
		/// </summary>
		public DSPMPVSCD_UPMovieClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DSPMPVSCD_UPMovieClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieClipboardCommandSetBase.
		/// </summary>
		protected DSPMPVSCD_UPMovieClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
