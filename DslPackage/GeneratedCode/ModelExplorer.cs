...
namespace UPM_IPS.DSPMPVSCDProyectoIPS
{
	...
	/// </summary>
	internal partial class DSPMPVSCDProyectoIPSExplorer : DSPMPVSCDProyectoIPSExplorerBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSExplorer.
		/// </summary>
		public DSPMPVSCDProyectoIPSExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DSPMPVSCDProyectoIPSExplorerToolWindow.
	/// </summary>
	internal abstract class DSPMPVSCDProyectoIPSExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSExplorerBase.
		/// </summary>
		protected DSPMPVSCDProyectoIPSExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DSPMPVSCDProyectoIPSExplorerMenu;
			}
		}
