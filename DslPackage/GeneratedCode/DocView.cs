...
namespace UPM_IPS.DSPMPVSCDProyectoIPS
{
	...
	/// </summary>
	internal partial class DSPMPVSCDProyectoIPSDocView : DSPMPVSCDProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSDocView.
		/// </summary>
		public DSPMPVSCDProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSPMPVSCDProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DSPMPVSCDProyectoIPSDocView.
		/// </summary>
		protected DSPMPVSCDProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DSPMPVSCDProyectoIPSDocDataBase docData = this.DocData as DSPMPVSCDProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DSPMPVSCDProyectoIPSDocViewBase should be an DSPMPVSCDProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DSPMPVSCDProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.DSPMPVSCDProyectoIPS.DSPMPVSCDProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
