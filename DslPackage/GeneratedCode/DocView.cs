...
namespace UPM_IPS.DSPMPVSCD_UPMovie
{
	...
	/// </summary>
	internal partial class DSPMPVSCD_UPMovieDocView : DSPMPVSCD_UPMovieDocViewBase
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieDocView.
		/// </summary>
		public DSPMPVSCD_UPMovieDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSPMPVSCD_UPMovieDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DSPMPVSCD_UPMovieDocView.
		/// </summary>
		protected DSPMPVSCD_UPMovieDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DSPMPVSCD_UPMovieDocDataBase docData = this.DocData as DSPMPVSCD_UPMovieDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DSPMPVSCD_UPMovieDocViewBase should be an DSPMPVSCD_UPMovieDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DSPMPVSCD_UPMovieDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.DSPMPVSCD_UPMovie.DSPMPVSCD_UPMovieHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
